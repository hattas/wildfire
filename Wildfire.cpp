...
void myDisplay(void) {
	...
	switch (gameState) {
		...
		case(HOW_TO_PLAY): renderTiles(); drawGrid(); howToPage(); glutSwapBuffers(); break;
		case(ABOUT): renderTiles(); drawGrid(); aboutPage(); glutSwapBuffers(); break;
